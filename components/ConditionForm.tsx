    ...
    >
      ...
      <div style={{
        ...
        <div>
          ...
          {isDuplicate && (
            <p style={{ fontSize: 12, color: 'var(--text-tertiary)', marginTop: 2 }}>キーワードか価格を変えて追加できます</p>
          )}
          {isEdit && !isDuplicate && (
      ...
      <div style={{ padding: '16px 20px calc(env(safe-area-inset-bottom, 24px) + 24px)' }}>
